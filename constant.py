...
__author__ = "TheOnlyMrLucifer <luciferbusiness@protonmail.com>"
...
3. You can optionally choose to become 'VIP' user if you need more traffic. Type /vip for more information.
    ...
    about = "YouTube-DL by TheOnlyMrLucifer Msg My On Telegram If You Need Help @TheOnlyMrLucifer"
...
**Payment method:**
1. (buy me a coffee) Other countries or regions: {COFFEE_LINK}
2. Paypal Friends/Family Payment : {AFD_LINK}
__If You Can't Do Coffee Msg My. So...__

**After payment:**
1. Paypal: with your order number `/vip 123456`
2. buy me a coffee: with your email `/vip someone@else.com`
    """ if ENABLE_VIP else "VIP is not enabled."
    vip_pay = "Processing your payments...If it's not responding after one minute, please contact @TheOnlyMrLucifer."
